...
/**
 * @class implementation class App.
...
class App
{
    ...
    //////////////////////////////////////////////////////
    /**
     * Method that allows knowing the client's ip.
     */
    ...
    /**
     * Method that allows knowing the information of the client's IP from geoplugin.
     */
    public static function ipInfo($ip = NULL, $purpose = "location", $deep_detect = TRUE)
    {
        ...
        $purpose    = str_replace(array("name", "\n", "\t", " ", "-", "_"), $auxNull, strtolower(trim($purpose)));
